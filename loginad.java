    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            new Thread(() -> {
                ...
                runOnUiThread(() -> {
                    if (response.contains(kn)) {
                        ...
                        Intent intent = new Intent(loginad.this, SelectAd.class);
                        startActivity(intent);

                    } else {

                        Toast.makeText(loginad.this, "Login Response: " + response, Toast.LENGTH_SHORT).show();
        ...
        btnEX.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(loginad.this, Home.class);
                startActivity(intent);
            }
        });
    }
